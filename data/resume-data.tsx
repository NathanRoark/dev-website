  ...
  work: [
    {
      ...
      bullets: [
        "Lead a team of 5 engineers to create the frontend for an AI application for use in conducting operational tests.", // TCAI
        "Created a new application as an extension to an existing application to allow for note taking and sharing between users in real time at scale during a Cyber Table Top or other event.", // Note Taking
        "Created a new application to allow for a flight paths generated by an AI on a microcontroller to be visualized in real time on a map.", // Flight Viz
        "Created a new application for visualizing and interacting with large complex data sets in 2D and 3D space.", // Data Viz
      ],
    },
    {
      company: "Trideum",
      ...
      bullets: [
        "Created a new application that could transform all forms of military and simulation messages into any other form of mil or sim message.", // Hermes
        "Created a new modeling and simulation application that interfaced with our existing applications to process Link16, VMF, and DIS traffic.", // BluPill
        "Updated and maintained several applications for internal and external customers.", // CT3, Radar Emulator
      ],
    },
  ],
  skills: [
